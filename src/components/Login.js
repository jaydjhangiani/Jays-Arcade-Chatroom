...
function Login() {
    ...
    return (
        ...
        <LoginContainer>
            ...
            <FormContent>
                <Form action ="#">
                    <FormH1>The Retro Arcade Chat Room</FormH1>
                    ...
                    <FormButton onClick={handleSignIn} type="submit">Continue</FormButton>
                    <Text href="https://jays-arcade-2eec1.firebaseapp.com/" >Don't have an account? Sign up!</Text>
                </Form>
            </FormContent>
